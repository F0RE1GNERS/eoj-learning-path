...
class ImplicitSequenceModel(object):
    ...
    def fit(self, interactions, verbose=False, on_every_n_epochs=None, n_epochs=5):
        """
        Fit the model.
        ...
        for epoch_num in range(1, self._n_iter + 1):
            ...
            if on_every_n_epochs is not None and epoch_num % n_epochs == 0:
                on_every_n_epochs(epoch_num=epoch_num, epoch_total=self._n_iter)
